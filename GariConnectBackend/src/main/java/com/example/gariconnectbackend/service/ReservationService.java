...
//
//    // =========================================================================
//    // 📝 1. CRÉATION D'UNE RÉSERVATION (Utilisée en interne ou via API alternatives)
//    // =========================================================================
//    @Transactional
...
//
//        // 🟢 SÉCURITÉ : Vérification de la disponibilité MULTIPLACES
...
//
//    // =========================================================================
//    // 💰 2. ENCAISSEMENT ET FINALISATION
//    // =========================================================================
//    @Transactional
...
//
//    // =========================================================================
//    // 🛠️ MÉTHODES UTILITAIRES ET GESTION DES NOTIFICATIONS
//    // =========================================================================
//
...
//
//        // 🟢 RESTITUTION DU NOMBRE DE PLACES EXACT
...
//
//    // =========================================================================
//    // 🔍 LECTURE DES DONNÉES ET HISTORIQUE
//    // =========================================================================
//
...
////
////            // 🟢 Prise en compte de la logique multi-places
////            int places = (res.getNombrePlaces() != null && res.getNombrePlaces() > 0) ? res.getNombrePlaces() : 1;
////            dto.setNombrePlaces(places);
////
////            // Récupération des détails de la demande VIP / Récupération
////            Optional<DemandeRecuperation> demandeOpt = demandeRecuperationRepository.findByReservationId(res.getId());
////
////            double montantBase = res.getMontantTotal() != null ? res.getMontantTotal() : 0.0;
////            double surplus = 0.0;
////
...
////                surplus = dm.getPrixSupplementaire() != null ? dm.getPrixSupplementaire() : 0.0;
////                dto.setPrixSupplementaire(surplus);
////            } else {
...
////            // Si votre montant de base en BDD n'inclut pas déjà le surplus VIP, on l'ajoute ici.
////            // (Ajustez cette formule si le surplus doit aussi être multiplié par le nombre de places)
////            double montantCalculé = montantBase + surplus;
////
////            dto.setMontantTotal(montantCalculé);
////
////            return dto;
////        }).collect(Collectors.toList());
////    }
...
//            }
//
//            // 🟢 LE CHIFFRE DU BACKEND : C'est le montant global facturé (ex: 36 000 FC)
//            // Ce montant inclut déjà toutes les places normales.
//            dto.setMontantTotal(res.getMontantTotal());
//
//            // Injection du nombre de places exact
//            int nbrPlaces = (res.getNombrePlaces() != null && res.getNombrePlaces() > 0) ? res.getNombrePlaces() : 1;
//            dto.setNombrePlaces(nbrPlaces);
//
//            // Gestion de la récupération (VIP)
//            Optional<DemandeRecuperation> demandeOpt = demandeRecuperationRepository.findByReservationId(res.getId());
//            if (demandeOpt.isPresent()) {
//                DemandeRecuperation dm = demandeOpt.get();
//                dto.setTypeReservation("VIP");
//                dto.setAdresseRamassage(dm.getAdresseTextuelle());
//
//                // Le prix supplémentaire (ex: 5 000 FC pour le ramassage VIP)
//                dto.setPrixSupplementaire(dm.getPrixSupplementaire() != null ? dm.getPrixSupplementaire() : 0.0);
//
//                // Note : Si ton montantTotal en BDD n'inclut pas encore le supplément VIP à la création,
//                // et que tu veux l'afficher dans le montant total global de l'historique :
//                // dto.setMontantTotal(res.getMontantTotal() + dto.getPrixSupplementaire());
//            } else {
//                dto.setTypeReservation("STANDARD");
